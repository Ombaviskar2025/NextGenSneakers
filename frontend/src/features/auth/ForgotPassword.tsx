    ...
    <div className="min-h-[75vh] flex items-center justify-center py-8 px-4 animate-fade-in font-sans">
      <div className="bg-white dark:bg-slate-900 border dark:border-slate-800 p-8 rounded-3xl max-w-sm w-full shadow-lg space-y-6 text-sm">
        ...
        <div className="text-center space-y-2">
          ...
          <h2 className="text-xl font-extrabold text-slate-900 dark:text-white mt-2">Password Recovery</h2>
          <p className="text-[11px] text-slate-400">Enter your email to receive a password reset link.</p>
        </div>

        {isSuccess ? (
          <div className="p-4 bg-emerald-50 dark:bg-emerald-950/20 text-emerald-600 dark:text-emerald-400 rounded-xl text-center text-xs border dark:border-emerald-900">
        ...
        <p className="text-center text-xs text-slate-500">
          Remember credentials? <Link to="/login" className="text-brand-500 font-bold hover:underline">Sign in</Link>
        </p>
